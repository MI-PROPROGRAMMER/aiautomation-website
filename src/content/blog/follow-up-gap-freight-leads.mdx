...
## Three signs the gap is open on your desk right now

1. You do not know what touch number your reps reach, on average, before a lead either books or goes silent.
2. Your top rep's "secret" is that they keep a notebook of leads they are tracking outside the CRM.
3. You have run a list of 6-month-old "lost" leads in the past year and been surprised how many had only one or two emails on them.

Any one of those means the gap is wider than you think — and almost certainly wider than the competitors who have already closed it.
...
If you can list the last 50 inbound leads your team did not follow up past touch two, you can roughly estimate what closing the follow-up gap is worth on your desk. We typically find the recoverable number is between two and four times current monthly lead spend.

[See how we close the follow-up gap on freight sales desks →](/services)
