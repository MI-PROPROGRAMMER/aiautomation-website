...
First-look automation on tenders is narrow and well bounded — the kind of engagement [the AI automation services menu](/services) is written around, where the scope is one decision and the acceptance criteria fit on a single page. The compounding effects are covered in [OTIF penalties on retail freight](/blog/otif-penalties-erode-broker-margin-retail-freight), [receiver appointment portals](/blog/receiver-appointment-portals-ftl-broker-cycle-time), and [off-hours loads slipping through](/blog/off-hours-loads-slip-mid-size-freight-brokerages).
