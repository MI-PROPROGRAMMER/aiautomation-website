...
The hard part was never the comparison. It is normalising forty inconsistent proposals into something comparable, and that is discovery work best done beside the estimating desk — the shape of [a forward deployed engineering engagement](/services/forward-deployed-engineer). Adjacent pressure on the same desk shows up in [estimating capacity limits](/blog/estimating-capacity-caps-mid-size-gc-pipeline), [trade buyout overruns](/blog/trade-buyout-overruns-erode-gc-job-margin), and [subcontractor prequal cycle time](/blog/subcontractor-prequal-cycle-time-gc-preconstruction).
