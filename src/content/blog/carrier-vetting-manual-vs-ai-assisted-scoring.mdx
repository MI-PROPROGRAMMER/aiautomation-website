...
Scoring rules that survive contact with a real carrier file get written next to the people applying them, not in a requirements document — which is why vetting work usually runs as [an embedded delivery engagement](/services/forward-deployed-engineer). The related exposure is set out in [double-brokering fraud](/blog/double-brokering-fraud-mid-size-brokerages), [expired carrier documents](/blog/expired-carrier-docs-broker-capacity-loss), and [onboarding backlogs capping spot coverage](/blog/carrier-onboarding-backlogs-cap-broker-spot-coverage).
