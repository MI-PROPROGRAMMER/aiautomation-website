...
Almost none of that is model work. It is discovery, integration, and exception design against live data, which is the argument for [embedding an engineer in the ops team](/services/forward-deployed-engineer) rather than handing over a specification and waiting. The upstream causes are covered in [multi-channel inventory drift](/blog/multi-channel-inventory-drift-dtc) and [split shipments across warehouses](/blog/split-shipments-dtc-multi-warehouse-margin-leak); the downstream ticket volume is [the WISMO backlog](/blog/ai-wismo-tickets-dtc-brand).
