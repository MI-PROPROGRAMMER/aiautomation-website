...
// The project set is shared with the specialist service pages, so it lives in
// src/content/portfolio.ts — see the note there.
import { PORTFOLIO_ITEMS, type PortfolioMedia } from "@/content/portfolio";
