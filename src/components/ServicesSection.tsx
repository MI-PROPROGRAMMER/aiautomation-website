...
export const ServicesSection = () => {
  return (
    <section id="services" className="py-24 bg-[#F2F2F2]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="glass-card-light rounded-3xl p-10 hover-lift">
            ...
            <h3 className="text-3xl font-bold text-primary mb-4">Low-Code/No-Code Agility</h3>
            <p className="text-lg text-primary mb-6">Fast, Flexible, and Powerful</p>
          ...
          <div className="glass-card-light rounded-3xl p-10 hover-lift">
            ...
            <h3 className="text-3xl font-bold text-primary mb-4">Custom-Coded Precision</h3>
            <p className="text-lg text-primary mb-6">Complex Problems, Tailored Solutions</p>
            <p className="text-primary/80 mb-6 leading-relaxed">
